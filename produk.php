...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> <!--logo-->
...
<body>
    ...
    <div class="main-product">
        <h2><span class="product-title">Kategori Produk</span> Kami</h2>
        <div class="product-container">
            <?php
            foreach($res->fetch_all() as $item) {
            ?>
            <a href="produk_kategori.php?kategori=<?= $item[2] ?>" class="product-item-link">
                <div class="product-item">
                    <h3><?= $item[2] ?></h3>
                    <img src="<?= $item[1] ?>" alt="kategori">
                    <h3><?= $item[3] ?></h3>
                    <p><?= $item[5] ?></p>
                </div>
            </a>
